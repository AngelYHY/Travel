...
import productorderstatedao.GetAllIsReceivedao;
...
public class OrderStateAllIsReceiveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public OrderStateAllIsReceiveServlet() {
        super();
...
//		来获取一些商品的具体信息和收货地址的一些具体信息
		...
		GetAllIsReceivedao getAllIsReceivedao=new GetAllIsReceivedao();
		list2=getAllIsReceivedao.getallisreceive(accountname);
//		用一个for循环，遍历其中,根据订单中商品id去查商品的一些具体情况，和收货地址的一些具体地址
		...
		ProductOrderState bean=new ProductOrderState(name, phone_num, detailed_addr, province, city, product_price, product_picture1, product_name,express_number, buyer_message, null, 0, null, 0, back_time,1,pay_time,1, order_time, account_name, product_id, product_count, receive_id, order_id);
		list1.add(bean);
