...
public class Keepsakedao implements ClassificationProduct {
	...
	List<Product> list = new ArrayList<Product>();
		...
		try {
			...
			statement = connection.prepareStatement("select * from product where product_city='"+gouwudingweicityname+"' and product_categoty_id='"+jinianpin+"' order by pk_product_id desc limit ?,?");
