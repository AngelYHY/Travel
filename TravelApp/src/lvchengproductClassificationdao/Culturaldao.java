...
public class Culturaldao implements ClassificationProduct {
	...
	List<Product> list = new ArrayList<Product>();
		...
		try {
			...
			String wenhuachanpin="文化产品";
			statement = connection.prepareStatement("select * from product  where product_city='"+gouwudingweicityname+"' and product_categoty_id='"+wenhuachanpin+"' order by pk_product_id desc limit ?,?");
